import type { WalletWithFeatures, WalletWithRequiredFeatures } from '@onelabs/wallet-standard';
...
export declare function WalletProvider({ preferredWallets, walletFilter, storage, storageKey, enableUnsafeBurner, autoConnect, stashedWallet, theme, children, }: WalletProviderProps): import("react/jsx-runtime.js").JSX.Element;
