...
var container = "WalletListItem_container__2ueejb0";
...
function WalletListItem({ name, icon, onClick, isSelected = false }) {
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("li", { className: container, children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
    "button",
    {
      ...
      onClick,
      children: [
        icon && typeof icon === "string" ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("img", { className: walletIcon, src: icon, alt: `${name} logo` }) : icon,
